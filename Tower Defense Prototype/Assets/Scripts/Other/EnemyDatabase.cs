...
public class EnemyDatabase : MonoBehaviour
{
    ...
    private void BuildDatabase()
    {
        enemies = new List<Enemy>
        {
            ...
            new Enemy(4, "Enemy2", 50, 2.5f, MovementType.GROUND, "Prefabs/Enemy2"),
            ...
            new Enemy(7, "Enemy2", 95, 1.6f, MovementType.GROUND, "Prefabs/Enemy2"),
            ...
            new Enemy(10, "Enemy2", 75, 2.5f, MovementType.GROUND, "Prefabs/Enemy2"),
        };
    }
